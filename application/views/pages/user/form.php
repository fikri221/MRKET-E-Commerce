            ...
            <?= form_open_multipart($form_action, ['method' => 'POST']) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        'checked' => $input->role == 'admin' ? true : false, 'class' => 'form-check-input']) ?>
                        <label for="" class="form-check-label">Admin</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <?= form_radio(['name' => 'role', 'value' => 'member', 
                        'checked' => $input->role == 'member' ? true : false, 'class' => 'form-check-input']) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        'checked' => $input->is_active == '1' ? true : false, 'class' => 'form-check-input']) ?>
                        <label for="" class="form-check-label">Aktif</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <?= form_radio(['name' => 'is_active', 'value' => '0', 
                        'checked' => $input->is_active == '0' ? true : false, 'class' => 'form-check-input']) ?>
