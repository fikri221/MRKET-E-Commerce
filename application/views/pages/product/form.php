            ...
            <?= form_open_multipart($form_action, ['method' => 'POST']) ?>
                ...
                <div class="form-group">
                    ...
                    <?= 
                      ...
                      'row' => 4, 'class' => 'form-control ckeditor']);
                     ?>
                ...
                <div class="form-group">
                    ...
                    <?= 
                      form_dropdown('id_category', getDropdownList(
                        'category', ['id', 'title']
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        'checked' => $input->is_available == 1 ? true : false, 'class' => 'form-check-input']) ?>
                        <label for="" class="form-check-label">Tersedia</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <?= form_radio(['name' => 'is_available', 'value' => 0, 
                        'checked' => $input->is_available == 0 ? true : false, 'class' => 'form-check-input']) ?>
